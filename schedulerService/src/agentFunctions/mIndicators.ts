 ...
 */
export function macd(ohlcv: OHLCV[] | number[][], fast = 12, slow = 26, signalPeriod = 9, slice: number = 0) {
  ...
  return { maCD: macdLine, signal, histogram, emaFast, emaSlow };
}
